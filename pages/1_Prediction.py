...
st.write("")
#############################################
# 3-COLUMN LAYOUT WITH SPACE BETWEEN MODELS
#############################################
...
with left:
    ...
    with col1:
        st.markdown("<span class='question'>Sex</span>", unsafe_allow_html=True)
    with col2:
    ...
    col1, col2 = st.columns([1,1])
    with col1:
        st.markdown("<span class='question'>Age</span>", unsafe_allow_html=True)
    with col2:
    ...
    col1, col2 = st.columns([1,1])
    with col1:
        st.markdown("<span class='question'>Education</span>", unsafe_allow_html=True)
    with col2:
    ...
    col1, col2 = st.columns([1,1])
    with col1:
        st.markdown("<span class='question'>Health insurance</span>", unsafe_allow_html=True)
    with col2:
    ...
    col1, col2 = st.columns([1,1])
    with col1:
        st.markdown("<span class='question'>Health worker</span>", unsafe_allow_html=True)
    with col2:
    ...
    col1, col2 = st.columns([1,1])
    with col1:
        st.markdown("<span class='question'>Doctor recommendation</span>", unsafe_allow_html=True)
    with col2:
...
with right:
    ...
    with col2: sex_fake = st.radio("", ["Male", "Female"], key="sex_seas")
